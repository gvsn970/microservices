...
<%
	...
	if(userSession != null ){
		...
		boolean status= utilitiesController.authorizationsCheck("Tax Setup",menu);
...
<div id="wrapper"> 
  ...
  <div class="left side-menu">
    <div class="sidebar-inner slimscrollleft"> 
      <!--- Divider -->
      <div id="sidebar-menu">
       <%=utilitiesController.getMenuNavigationForActivePage("company_taxdetails",menu) %>
  ...
  <div class="content-page"> 
    ...
    <div class="content">
      <div class="container"> 
        ...
        <div class="row">
          <div class="col-sm-12">
            <h4 class="page-title">NexiiLabs Tax Details</h4>
            <ol class="breadcrumb">
              <li class="active">PAN Details </li>
              <li class="active"> NexiiLabs Tax Details </li>
            </ol>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="card-box col-md-12">
                    <div class="col-sm-6">
                    <h4 class="m-t-0 header-title"><b>Tax Details</b></h4>
                    <form class="form-horizontal" role="form"  data-parsley-validate novalidate>
                        <div class="form-group">
                            <label class="col-sm-4 control-label">PAN Number*</label>
                            <div class="col-sm-7">
                                <input type="text" required parsley-type="text" class="form-control" id="panNumber">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-4 control-label">GSTIN*</label>
                            <div class="col-sm-7">
                                <input type="text" required parsley-type="text" class="form-control" id="gstIn">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-4 control-label">State*</label>
                            <div class="col-sm-7">
                                <input type="text" required parsley-type="text" class="form-control" id="stateName">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="text" required parsley-type="text" class="form-control" id="stateCode">
                            </div>
                        </div>
                        
                        <div class="form-group">
                            <div class="col-sm-offset-4 col-sm-8">
                                <button type="button" class="ladda-button  btn btn-info" data-style="slide-left" id="savetax" onclick="addTaxDetails()">
                                    Create
                                </button>
                            </div>
                            <span id="taxErrorMessage"></span>
                        </div>
                    </form>
                    </div>
                    <h4 class="m-t-0 header-title"><b>GSTIN Accounts</b></h4>
                    <div class="col-sm-6" id="taxList">
  ...
  <div id="custom-modal-edit" class="modal-demo">
			    ...
			    <div class="custom-modal-text">
			        <div class="panel-body">
                        ...
                        <div class="col-md-6"> 
                        <div class="form-group">
                        <label class="control-label pull-left">PAN Number</label> 
                        <input type="text" class="form-control" placeholder="PAN Number" id="updatepanNumber"> 
                        </div> 
                        </div>
                        <div class="col-md-6"> 
                        <div class="form-group"> 
                        <label class="control-label pull-left">GSTIN</label> 
                        <input type="text" class="form-control" placeholder="GSTIN Number" id="updategstIn"> 
                        </div> 
                        </div> 
                        </div> 
 						<div class="row"> 
                        ...
                        <input type="text" class="form-control" placeholder="State" id="updatestateName"> 
                        </div> 
                        </div> 
                        <div class="col-md-6"> 
                        <div class="form-group">
                        <label class="control-label pull-left">State Code</label>  
                        <input type="text" class="form-control" placeholder="State Code" id="updatestateCode"> 
                        </div> 
                        </div> 
                        </div>
 						<div class="row m-t-20">
                            <div class="col-md-12 text-right">
                                <button class="btn btn-primary waves-effect" id="updateTax">Save Changes</button>
                                <button class="btn btn-default waves-effect" onclick="Custombox.close();">Cancel</button>
                            </div>
                            <span id="updatetaxErrorMessage"></span>
                        </div>
