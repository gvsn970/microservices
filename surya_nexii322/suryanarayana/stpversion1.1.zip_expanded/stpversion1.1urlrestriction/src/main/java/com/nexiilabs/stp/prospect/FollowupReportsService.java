...
public interface FollowupReportsService {
	...
	List<FollowupProspectListResponseDTO> dateRangeUpdatedFollowupReportsList(int userId,String startDate, String endDate, int userTypeId);

	List<FollowupProspectListResponseDTO> dateRangeNotUpdatedFollowupReportsList(int userId,String startDate, String endDate,int userTypeId);
