...
!function($) {
    ...
    Dashboard4.prototype.init = function() {
        ...
        this.createAreaChart('morris-area-example', 0, 0, $areaData, 'y', ['a', 'b','c'], ['Mobiles', 'Tablets','Desktops'], ['#0f60ab', '#34d3eb', '#bbbbbb']);
        ...
        this.createBarChart('morris-bar-example', $barData, 'y', ['a', 'b', 'c'], ['Series A', 'Series B', 'Series C'], ['#0f60ab', '#34d3eb', '#ebeff2']);
