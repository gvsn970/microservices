		...
		<div id="wrapper">
                            ...
                            <ul class="nav navbar-nav navbar-right pull-right" id="notification">
                                <li id="logout" class="dropdown top-menu-item-xs">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="divider"></li>
                                        <li><a onclick="logout();"><i class="ti-power-off m-r-10 text-danger"></i> Logout</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
            ...
            <div class="left side-menu">
                <div class="sidebar-inner slimscrollleft">
                    <!--- Divider -->
                    <div id="sidebar-menu">
                      <%=utilitiesController.getMenuNavigationForActivePage("active_resources",menu) %>
			...
			<div class="content-page">
				...
				<div class="content">
					<div class="container">
						...
						<div class="row">
							<div class="col-sm-12">
								<h4 class="page-title">Active Resources</h4>
                                <ol class="breadcrumb">
                                  <li> <a href="#">Resources</a> </li>
                                  <li class="active"> Active Resources </li>
                                </ol>
							</div>
						</div>
                                        ...
                                        <div id="basic-form-add-res">
                                          ...
                                          <!--   <button type="button" class="ladda-button  btn btn-info" data-style="slide-left" id="updateproject">Update Project Info</button> -->
                                            ...
                                            <form id="sowForm" enctype="multipart/form-data">
						                      ...
						                      <div class="col-md-6">
						                        <div class="form-group">
						                          <input type="file" name="files" id="sowFile"  class="filestyle" data-classButton="btn btn-primary" data-input="false" data-classIcon="icon-plus" data-buttonTextt="Upload Files" multiple accept=".doc,.pdf,.docx" >
						                        </div>
						                      </div>
						                      <div class="col-md-6">
						              ...
						              <!--  <button type="button" class="ladda-button  btn btn-info" data-style="slide-left" id="updatesow">Update SOW Info</button> -->
						                <span id="sowErrorMessage"></span> 
                                            ...
                                            <form id="poForm" enctype="multipart/form-data">
						                      ...
						                      <div class="col-md-6">
							                        <div class="form-group">
							                          <input type="file" name="files" id="poFile"  class="filestyle" data-classButton="btn btn-primary" data-input="false" data-classIcon="icon-plus" data-buttonTextt="Upload Files" multiple accept=".doc,.pdf" >
							                        </div>
							                      </div>
							                      <div class="col-md-6">
							                        <table class="tablesaw table m-b-0 table-bordered">
			        ...
			        <div class="panel-body">
                     <div class="row">
							...
							<div class="col-lg-12">
								<div class="panel panel-color panel-custom table-bordered">
									<div class="panel-heading">
										<h3 class="panel-title text-left">Work/Project Info</h3>
									</div>
									<div class="panel-body text-left" id="projectInfoPreview">
							...
							<div class="col-lg-12">
								<div class="panel panel-color panel-custom table-bordered">
									<div class="panel-heading">
										<h3 class="panel-title text-left">Uploaded SOW Files</h3>
									</div>
									<div class="panel-body text-left">
                                    	<div class="row">
									<div class="col-md-6" id="sowfilesForPreview1"></div><div class="col-md-6" id="sowfilesForPreview2"></div>
                                        </div>
									</div>
								</div>
							</div>
                     ...
                     <div class="row">
							<div class="col-lg-12">
								<div class="panel panel-color panel-custom table-bordered">
									<div class="panel-heading">
										<h3 class="panel-title text-left">PO Details</h3>
									</div>
									<div class="panel-body text-left" id="poForPreview"></div>
								</div>
							</div>
							<div class="col-lg-12">
								<div class="panel panel-color panel-custom table-bordered">
									<div class="panel-heading">
										<h3 class="panel-title text-left">Uploaded PO Files</h3>
									</div>
									<div class="panel-body text-left">
                                    	<div class="row">
									<div class="col-md-6" id="pofilesForPreview1"></div><div class="col-md-6" id="pofilesForPreview2"></div>
                                        </div>
									</div>
								</div>
							</div>
