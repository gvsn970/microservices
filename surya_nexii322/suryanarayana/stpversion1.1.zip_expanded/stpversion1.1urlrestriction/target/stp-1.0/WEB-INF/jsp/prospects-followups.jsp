      ...
      <div class="container">
        <div class="">
          ...
          <ul class="nav navbar-nav navbar-right pull-right" id="notification">
                                <li class="dropdown top-menu-item-xs" id="logout">
  ...
  <div class="content-page"> 
    ...
    <div class="content">
      <div class="container"> 
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="btn-group pull-right m-t-15"> <a href="#custom-modal-create" onClick="createProspectDiv();" class="btn btn-default waves-effect waves-light text-info m-r-10" data-animation="fadein" data-plugin="custommodal" data-overlaySpeed="200" data-overlayColor="#36404a">Add Contacts<span class="m-l-5"><i class="fa fa-user-plus"></i></span></a> </div>
            <h4 class="page-title">Followups</h4>
            <ol class="breadcrumb">
              <li class="active">Prospects </li>
              <li class="active"> Followups </li>
            </ol>
          </div>
        </div>
         <div class="row">
          ...
          <div class="col-sm-12">
            <div class="card-box table-responsive">
              <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                ...
                <tbody id="todayfollowupList">
                 <!--  <tr class="gradeX">
                    <td>Name One</td>
                    <td>Company One</td>
                    <td>someone@company.com</td>
                    <td>01-03-2018</td>
                    <td><a href="#custom-modal-update" class="on-default text-info m-r-10" data-animation="fadein" data-plugin="custommodal" data-overlaySpeed="200" data-overlayColor="#36404a">Update</a></td>
                  </tr> -->
                </tbody>
              </table>
            </div>
...
<!-- Add Contacts MODAL -->
  <div id="custom-modal-create" class="modal-demo">
    <button type="button" class="close" onclick="Custombox.close();"> <span>&times;</span><span class="sr-only">Close</span> </button>
    <h4 class="custom-modal-title">Create Contact</h4>
    <div class="custom-modal-text">
      <div class="panel-body">
        <div class="col-md-12" id="addProspect">
          
          <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label class="control-label pull-left">First Name</label>
                    <input id="createprospectfName" type="text" class="form-control" placeholder="Name One" required>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label class="control-label pull-left">Last Name</label>
                    <input id="createprospectlName" type="text" class="form-control" placeholder="Name One" required>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label class="control-label pull-left">Email</label>
                    <input id="createprospectemail" type="email" class="form-control" placeholder="someone@company.com" required>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label class="control-label pull-left">Phone Number</label>
                    <input id="phnumber" type="text" class="form-control" placeholder="9876543210" required>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label class="control-label pull-left">Alternate Number</label>
                    <input id="alternumber" type="text" class="form-control" placeholder="9876543210">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label class="control-label pull-left">Designation</label>
                    <input id="designation" type="text" class="form-control" placeholder="designation" required>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                   <label class="control-label pull-left">Address</label>
                        <input type="text" class="form-control" style="border-left: none;border-right: none;border-top: none;" placeholder="Address Lane1" maxlength="75" id="addlane1">
                      	<input type="text" class="form-control" style="border-left: none;border-right: none;border-top: none;" placeholder="Address Lane2" maxlength="75" id="addlane2">
                   </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group input-group">
                    <label class="control-label pull-left">Company</label>
                    <!--<input type="text" class="form-control" placeholder="Company One">-->
                    <select id="createprospectcustomer" class="form-control">
                        <option>Select</option>
                       <!-- <option>Company One</option>
                        <option>Company Two</option>-->
		            </select>
                    <div class="input-group-btn">
                        <a href="#" onClick="pageRedirect();" class="btn btn-primary" style="margin-top:25px;" data-toggle="modal-demo" data-target="#custom-modal-create"> <i class="fa fa-plus"></i> </a>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label class="control-label pull-left">Additional Information</label>
                    <textarea rows="3" class="form-control" id="information"></textarea>
                  </div>
                </div>
        ...
        <div class="row m-t-20">
          <div class="col-md-6 text-left">
            <button class="btn btn-primary waves-effect" onclick="addProspect();">Create</button>
            <button class="btn btn-default waves-effect" onclick="Custombox.close();">Cancel</button>
          </div>
          <span id="prospectErrorMessage"></span>
        </div>
      </div>
      <div class="col-md-12" id="addCompany" style="display:none;">
          
          <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label class="control-label pull-left">Company Name</label>
                    <input id="companyName1" type="text" class="form-control" placeholder="company" required>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
        ...
        <div class="row m-t-20">
          <div class="col-md-6 text-left">
            <button class="btn btn-primary waves-effect" onclick="addCompany();">Create</button>
            <button class="btn btn-default waves-effect" onclick="createProspectDiv();">Back</button>
          </div>
          <span id="companyerrMessage"></span>
        </div>
      </div>
    </div>
  </div>
...
<script type="text/javascript" src="assets/js/coockies.js"></script>
<script type="text/javascript">
	function pageRedirect() {
		$("#addProspect").hide();
		$("#addCompany").show();
	//$.cookie("popupstatus", true);
	//  window.location.href = "accounts";
	} 
	function createProspectDiv(){
		$("#addProspect").show();
		$("#addCompany").hide();
	}
